...
export const TASKS: Task[] = [
  { id: '1', label: 'Répondre demande PLU secteur Nord', commission: 'Travaux', assignee: 'Jean Martin', dueDate: '2 mai', priority: 'Urgent', status: 'En cours' },
  { id: '2', label: 'Valider devis éclairage — route des Combes', commission: 'Travaux', assignee: 'Jean Martin', dueDate: '5 mai', priority: 'Normal', status: 'À faire' },
  { id: '3', label: 'Préparer OJ Conseil du 8 mai', commission: 'Admin', assignee: 'Jean Martin', dueDate: '8 mai', priority: 'Normal', status: 'À faire' },
  { id: '4', label: 'Signer convention CC Pays de Vernoux', commission: 'Admin', assignee: 'Jean Martin', dueDate: '10 mai', priority: 'Normal', status: 'En attente validation' },
  { id: '5', label: 'Mise à jour registre état civil Q1', commission: 'Admin', assignee: 'P. Roche', dueDate: '15 mai', priority: 'Faible', status: 'En cours' },
  { id: '6', label: 'Suivi chantier route des Combes', commission: 'Travaux', assignee: 'L. Fabre', dueDate: '15 mai', priority: 'Normal', status: 'En cours' },
  { id: '7', label: 'Mise à jour site internet — actu mai', assignee: 'Communication', dueDate: '31 mai', priority: 'Faible', status: 'À faire' },
  { id: '8', label: 'Valider délibération 2026-015', commission: 'Admin', assignee: 'Jean Martin', dueDate: '6 mai', priority: 'Urgent', status: 'En attente validation' },
  { id: '9', label: 'Budget primitif 2026 adopté', commission: 'Finance', assignee: 'Jean Martin', dueDate: '1 avr.', priority: 'Normal', status: 'Terminé' },
  { id: '10', label: 'CR commission du 12 avril', commission: 'Admin', assignee: 'Marie D.', dueDate: '12 avr.', priority: 'Normal', status: 'Terminé' },
  { id: '11', label: 'Rapport annuel 2025 — ébauche', commission: 'Finance', assignee: 'Jean Martin', dueDate: '30 mai', priority: 'Faible', status: 'À faire' },
]
