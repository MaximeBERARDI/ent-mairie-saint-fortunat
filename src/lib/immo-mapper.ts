...
export function bienFromDb(b: DbBien & { documents?: DbDocument[] }): BienImmobilier {
  return {
    ...
    codeInsee: b.codeInsee ?? undefined,
    sectionCadastrale: b.sectionCadastrale ?? undefined,
    numeroParcelle: b.numeroParcelle ?? undefined,
...
export function bailFromDb(b: DbBail & { documents?: DbDocument[] }): Bail {
  return {
    ...
    loyerMensuel: Number(b.loyerMensuel),
    chargesMensuelles: Number(b.chargesMensuelles),
    chargesOrduresMensuelles: Number(b.chargesOrduresMensuelles),
    chargesGazMensuelles: Number(b.chargesGazMensuelles),
    chargesAutresMensuelles: Number(b.chargesAutresMensuelles),
...
export function quittanceFromDb(q: DbQuittance): Quittance {
  return {
    ...
    chargesOrdures: Number(q.chargesOrdures),
    chargesGaz: Number(q.chargesGaz),
    chargesAutres: Number(q.chargesAutres),
